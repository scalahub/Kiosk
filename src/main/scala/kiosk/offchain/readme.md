...
The exception to this rule is the [**Long**](compiler/model/package.scala#L86-L100) declaration, which can have both fields, 
...
An [`Address`](compiler/model/package.scala#L48-L61) declaration takes an optional sequence, `values`, 
